...
gray = (119, 118, 110)      # Color gris
black = (0, 0, 0)          # Color negro
red = (255, 0, 0)          # Color rojo
green = (0, 200, 0)        # Color verde
blue = (0, 0, 200)         # Color azul
bright_red = (255, 0, 0)   # Rojo brillante
bright_green = (0, 255, 0) # Verde brillante
bright_blue = (0, 0, 255)  # Azul brillante
